  ...
  return (
    <div className="bg-white-100">
      ...
      <div className="relative flex flex-col md:flex-row items-center md:items-start min-h-[70vh] py-10 px-8 mt-20 bg-stone-400"
       style={{ backgroundImage: "url('/databg.avif')" }}
       >
...
<div className="absolute inset-0 bg-black bg-opacity-50 rounded-lg"></div>
  ...
  <div className="max-w-lg w-full text-center md:text-left">
    ...
    Data analytics is the art of transforming raw data into meaningful insights using statistical and machine learning techniques. In today's data-driven world, businesses that harness the power of analytics gain a significant competitive advantage. By analyzing patterns, trends, and correlations, organizations can make well-informed decisions that drive growth and efficiency. Whether it’s optimizing marketing campaigns, improving customer experiences, streamlining operations, or innovating new products, data analytics serves as a guiding force in shaping business success. With the right analytical approach, businesses can uncover hidden opportunities, mitigate risks, and enhance overall performance.
    </p>
  </div>
