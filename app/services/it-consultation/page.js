  ...
  return (
    <div className="bg-white-100">
      ...
      <div className="relative flex flex-col md:flex-row items-center md:items-start min-h-[70vh] py-10 px-8 mt-20 bg-stone-400"
       style={{ backgroundImage: "url('/itbg.avif')" }}
       >
...
<div className="absolute inset-0 bg-black bg-opacity-50 rounded-lg"></div>
  ...
  <div className="max-w-lg w-full text-center md:text-left">
    ...
    Strategic IT Consultation: Transforming Vision into Reality
    </h2>
    <p className="text-gray-700 mt-4 leading-relaxed">
    In our realm, IT consulting is more than just offering advice—it’s a transformative journey of collaboration, execution, and unwavering support. Technology is at the heart of business success, and our adept consultants work closely with clients to develop strategies that drive innovation, enhance efficiency, and maximize ROI. We don’t just recommend solutions; we ensure their seamless integration into your operational framework, aligning technology with business goals to unlock new opportunities and create a competitive edge. With our expert guidance, businesses can confidently navigate the complexities of digital transformation and harness the full potential of their IT investments.
    </p>
  </div>
        ...
        <div className="bg-slate-400 text-neutral-950 py-10 px-8 rounded-2xl shadow-lg max-w-6xl w-full text-center">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-8 md:gap-12">
            ...
            <div className="flex flex-col items-center">
              ...
              <p>Increased Flexibility & Choice </p>
            </div>
