...
<div className="absolute inset-0 bg-black bg-opacity-50 rounded-lg"></div>
  ...
  <div className="max-w-lg w-full text-center md:text-left">
    ...
    Time & Material: Flexible and Result-Driven Solutions
    </h2>
    <p className="text-gray-700 mt-4 leading-relaxed">
    Our Time & Material services embody dependability, transparency, and measurable success. In an ever-evolving business landscape, organizations need flexible engagement models that ensure both efficiency and cost-effectiveness. With our Time & Material approach, businesses can scale their teams as needed, optimizing resources without the long-term commitments of traditional hiring. This model allows for greater adaptability, ensuring that projects are executed with precision, efficiency, and within budget. By leveraging a dynamic and skilled workforce, businesses can meet project demands effectively while maintaining complete control over costs and timelines.
    </p>
  </div>
        ...
        <div className="bg-slate-400 text-neutral-950 py-10 px-8 rounded-2xl shadow-lg max-w-6xl w-full text-center">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-8 md:gap-12">
            ...
            <div className="flex flex-col items-center">
              <img src="/time.png" alt="Accuracy" className="w-16 h-16 mb-2" />
              <p>Faster Project Execution
              </p>
            </div>
